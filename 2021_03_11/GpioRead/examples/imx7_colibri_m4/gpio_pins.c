...
/* Switch 3
 * SODIMM                BALL NAME                GPIO                ALT
 *    31                SD2_DATA1                 GPIO05_15           5
 */
gpio_config_t gpioSwitch3 = {
    "SODIMM 31",                                    /* name */
    &IOMUXC_SW_MUX_CTL_PAD_SD2_DATA1,               /* muxReg */
    5,                                              /* muxConfig */
    &IOMUXC_SW_PAD_CTL_PAD_SD2_DATA1,               /* padReg */
    IOMUXC_SW_PAD_CTL_PAD_SD2_DATA1_PS(2)  |        /* padConfig */
    	IOMUXC_SW_PAD_CTL_PAD_SD2_DATA1_PE_MASK |
    IOMUXC_SW_PAD_CTL_PAD_SD2_DATA1_HYS_MASK,
    GPIO5,                                          /* base */
    15                                              /* pin */
};

gpio_init_config_t Switch3 = {
    .pin           = 15, //pin number
    .direction     = gpioDigitalInput,
    .interruptMode = gpioNoIntmode
};

gpio_config_t gpioKeyFunc3 = {
    "EXT_Cynexo_front_Button",                                       /* name */
    &IOMUXC_SW_MUX_CTL_PAD_SD2_DATA1,               /* muxReg */
    5,                                              /* muxConfig */
    &IOMUXC_SW_PAD_CTL_PAD_SD2_DATA1,                  /* padReg */
    IOMUXC_SW_PAD_CTL_PAD_SD2_DATA1_PS(2) |        /* padConfig */
